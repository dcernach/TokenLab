...
public class Spell {
    ...
    @XmlAttribute(name = "casterlevel", required = true)
    @XmlJavaTypeAdapter(NormalizedStringAdapter.class)
    protected String casterlevel;

    @XmlAttribute(name = "castsleft")
    @XmlJavaTypeAdapter(NormalizedStringAdapter.class)
    protected String castsleft;

    @XmlAttribute(name = "casttime")
    @XmlJavaTypeAdapter(NormalizedStringAdapter.class)
    ...
    @XmlAttribute(name = "componenttext")
    @XmlJavaTypeAdapter(NormalizedStringAdapter.class)
    ...
    @XmlAttribute(name = "schooltext")
    @XmlJavaTypeAdapter(NormalizedStringAdapter.class)
    protected String schooltext;

    @XmlAttribute(name = "subschooltext")
    @XmlJavaTypeAdapter(NormalizedStringAdapter.class)
    protected String subschooltext;

    @XmlAttribute(name = "descriptortext")
    @XmlJavaTypeAdapter(NormalizedStringAdapter.class)
    protected String descriptortext;

    @XmlAttribute(name = "savetext")
    @XmlJavaTypeAdapter(NormalizedStringAdapter.class)
    protected String savetext;

    @XmlAttribute(name = "resisttext")
    @XmlJavaTypeAdapter(NormalizedStringAdapter.class)
